    ...
    <v-row dense>
      ...
      <v-col cols="12">
        <experience
          ...
          info="After completing my Bachelor of Technology (focus: Web Development) degree at SUNY Morrisville, I've had the opportunities to work and live in various places in New York State."
        ></experience>
        <skillset
          :max="skillset.max"
          :list="skillset.list"
          ...
          :info="` With years of experience throughout my career of ${skillset.max} years, I've built a strong skill-set.`"
        ></skillset>
        <hobby
          :list="hobbies"
